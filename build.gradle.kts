...
kotlin {
    ...
    val xcf = XCFramework("Webbrowser")
    ...
    swiftExport {
        ...
        flattenPackage = "io.github.kotlinmania.webbrowser"
    }

    android {
        namespace = "io.github.kotlinmania.webbrowser"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "webbrowser-kotlin", version.toString())

    pom {
        name.set("webbrowser-kotlin")
        description.set("Kotlin Multiplatform port of amodm/webbrowser-rs - Open URLs in web browsers available on a platform")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/webbrowser-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/webbrowser-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/webbrowser-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/webbrowser-kotlin.git")
        }
    }
}
