...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Webbrowser.swiftmodule/`
...
//      `import Webbrowser` above would fail at compile time.
//
//   2. The static archive `libWebbrowser.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Webbrowser" }` and
//      `flattenPackage = "io.github.kotlinmania.webbrowser"` configuration in
...
//      via the `WebbrowserLibrary` product.
//
...
final class WebbrowserExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Webbrowser swift module imported cleanly")
    }
}
