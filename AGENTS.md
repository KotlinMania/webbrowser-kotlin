...
This file is the quick-reference operating contract for webbrowser-kotlin. The longer
...
webbrowser-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`webbrowser`](https://crates.io/crates/webbrowser). Upstream Rust is the behavioral oracle while the
